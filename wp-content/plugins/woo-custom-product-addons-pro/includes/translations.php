...
$translations = [
    ...
    'fieldRemoveWarning' => __('Are you sure you want to remove this field?', 'wcpa-text-domain'),
    ...
    'show_in_cart_checkout'=>__('Show this in Cart, Checkout and Order Details pages','wcpa-text-domain'),
    ...
    'show_label_inside'=>__('Show Label inside of the color field','wcpa-text-domain'),
    'adjust_width_wrt_label'=>__('Adjust width based on the label inside','wcpa-text-domain'),
